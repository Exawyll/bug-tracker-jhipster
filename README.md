...
```
$ docker image tag bugtrackerjhipster gcr.io/kubernetes-267116/bugtrackerjhipster
$ docker push gcr.io/kubernetes-267116/bugtrackerjhipster
```
...
```
$ kubectl get svc bugtrackerjhipster -n production
```
...
```
$ kubectl scale deployment <app-name> --replicas <replica-count> -n production
```
...
```
$ kubectl set image deployment/<app-name>-app <app-name>=<new-image>  -n production
```
...
```
$ kubectl expose service jhipster-registry --type=NodePort --name=exposed-registry -n production
```

and explore the details using

```
$ kubectl get svc exposed-registry -n production
```

For scaling the JHipster registry, use

```
$ kubectl scale statefulset jhipster-registry --replicas 3 -n production
```
