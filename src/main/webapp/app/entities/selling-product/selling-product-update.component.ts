...
export class SellingProductUpdateComponent implements OnInit {
  ...
  updateForm(sellingProduct: ISellingProduct): void {
    this.editForm.patchValue({
      ...
      v2ProductName: sellingProduct.v2ProductName,
      v2ProductCategory: sellingProduct.v2ProductCategory,
      unitsSold: sellingProduct.unitsSold,
      revenue: sellingProduct.revenue
    });
  }
  ...
  private createFromForm(): ISellingProduct {
    return {
      ...
      v2ProductName: this.editForm.get(['v2ProductName'])!.value,
      v2ProductCategory: this.editForm.get(['v2ProductCategory'])!.value,
      unitsSold: this.editForm.get(['unitsSold'])!.value,
