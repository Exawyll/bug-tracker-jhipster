...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.SellingProduct}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class SellingProductResource {
    ...
    public ResponseEntity<SellingProduct> createSellingProduct(@RequestBody SellingProduct sellingProduct) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/selling-products/" + result.getId()))
    ...
    public ResponseEntity<SellingProduct> updateSellingProduct(@RequestBody SellingProduct sellingProduct) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, sellingProduct.getId().toString()))
            .body(result);
    }
