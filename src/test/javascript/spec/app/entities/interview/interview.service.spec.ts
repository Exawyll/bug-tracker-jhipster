...
describe('Service Tests', () => {
  describe('Interview Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Interview(0, currentDate, 'AAAAAAA', 'AAAAAAA', 0, 'AAAAAAA', InterviewTypeEnum.REMOTE);
    });
    ...
    describe('Service methods', () => {
      it('should find an element', () => {
        const returnedFromService = Object.assign(
          {
            occuredDate: currentDate.format(DATE_FORMAT)
          },
          elemDefault
        );
        service
